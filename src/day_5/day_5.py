    ...
    while i < len(list_op_codes):
        ...
        ## PART-2 POTENTIAL SOLUTIONS
            ...
            if parameter_types and parameter_types[0]:
                ...
                li = list_op_codes[i + 1]
            # set instruction ptr to li if not 0
            if li != 0:
                i = li
            else:
                i += 1
            ...
            if parameter_types and parameter_types[0]:
                ...
                li = list_op_codes[i + 1]
            # set instruction ptr to li if 0
            if li == 0:
                i = li
            else:
                i += 1
            ...
            li_1, li_2, li_3 = _parse_3_parameters()
            # set to 1 if parameter values equal
...
def main():
    ...
    i = 0
    list_op_codes, output_codes = retrieve_op_codes(initial_list_op_codes, 5)
    print(output_codes)
